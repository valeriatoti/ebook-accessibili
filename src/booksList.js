...
module.exports = {
   book1: {
      ...
      download: `https://github.com/valeriatoti/ebook-accessibili/blob/master/src/download/CluetrianManifesto.epub`
     },
     book2: {
      ...
      download: `https://github.com/valeriatoti/ebook-accessibili/blob/master/src/download/AARON.epub`
     }
}