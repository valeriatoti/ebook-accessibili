module.exports = {
   book4: {
      title: 'TAO TE CHING',
      subtitle: '– Il grande libro della Via e della Virtù',
      author: 'Lao Tzu',
      image: 'cover-tao-te-ching',
   ...
   book3: {
      title: 'Le nuove tesi del Cluetrain Manifesto',
      subtitle: '',
      author: 'Doc Searls & David Weinberger',
      image: 'cover-new-clues',
     ...
     book2: {
      title: 'AARON SWARTZ',
      subtitle: '– Una vita per la cultura libera e la giustizia sociale',
      author: 'Aaron Swartz & altri',
      image: 'cover-aaron',
