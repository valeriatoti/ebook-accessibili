  ...
  <Layout>
    <section className="container">
      ...
      <blockquote className="quote-image-cite">
        Gli ebook che trovi su questo sito sono creati con cura, rispettando le <em><a href="https://www.w3.org/Submission/2017/SUBM-epub-a11y-20170125/#sec-disc-package">specifiche dell'accessibilità</a></em>, in modo che tutti, anche le persone disabili, possano accedere al contenuto. Gli ebook sono gratuiti e senza <abbr title="Digital Rights Management: gestione dei diritti digitali." className="small-caps">DRM</abbr>.
